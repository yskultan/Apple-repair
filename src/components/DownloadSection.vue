        ...
        <v-col cols="10">
          <v-row align="center" justify="center">
            ...
            <v-col cols="12" sm="8" class="white--text text-left">
              <h1 class="font-weight-light display-2 mb-2">Download tutorials</h1>
              ...
              <v-btn rounded outlined href="https://youtube.com" target="_blank" large color="white" class="mt-4">
                YouTube
              </v-btn>
            </v-col>
          </v-row>

      ...
      <v-row align="center" justify="center">
        <v-col cols="10">
          <v-card style="width: 100%">
            <h1 class="text-center pt-6 font-weight-light display-2">Pricing</h1>
              ...
              <v-col class="col-12 col-sm-6 col-md-4">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text--disabled text-uppercase text-h5 my-2">Lorem</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">something</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">about</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">device</div>
                    <v-divider class="my-2"/>
              ...
              <v-col class="col-12 col-sm-6 col-md-4">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text--disabled text-uppercase text-h5 my-2">Ipsum</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">something</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">about</div>
              ...
              <v-col class="col-12 col-md-4">
                ...
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text--disabled text-uppercase text-h5 my-2">Dolor</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">something</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">about</div>
